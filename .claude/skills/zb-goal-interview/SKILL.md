...
### [모드 A] 프로젝트 초기 목표 문서
* **저장 경로**: `projects/[프로젝트명]/GOAL.md` (예: `projects/blog/GOAL.md`)
* **문서 구조**:
  ```markdown
...
* **저장 경로**: `projects/[프로젝트명]/docs/product-specs/[피처명]-spec.md` (예: `projects/blog/docs/product-specs/chat-feature-spec.md`)
* **문서 구조**:
  ```markdown
