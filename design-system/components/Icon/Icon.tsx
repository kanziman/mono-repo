...
export type IconName = 'search' | 'check' | 'close' | 'chevron-down' | 'github' | 'youtube' | 'book' | 'star' | 'file-text' | 'sun' | 'moon';
...
export const Icon: React.FC<IconProps> = ({ name, size = 24, className = '', ...props }) => {
  // SVG paths mocked based on coolicons style
  const getPath = () => {
    switch (name) {
      ...
      case 'close': return <><line x1="18" y1="6" x2="6" y2="18" /><line x1="6" y1="6" x2="18" y2="18" /></>;
