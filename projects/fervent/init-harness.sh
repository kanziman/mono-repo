...
echo "=== Starting Standardized Project Structure Setup ==="
...
# Create folders
create_dir_if_not_exist ".claude"
create_dir_if_not_exist ".claude/skills"
create_dir_if_not_exist ".claude/agents"
create_dir_if_not_exist ".claude/guides"
create_dir_if_not_exist "docs"
create_dir_if_not_exist "docs/design-docs"
create_dir_if_not_exist "docs/exec-plans"
create_dir_if_not_exist "docs/exec-plans/active"
create_dir_if_not_exist "docs/exec-plans/completed"
create_dir_if_not_exist "docs/product-specs"
create_dir_if_not_exist "docs/references"
create_dir_if_not_exist "docs/generated"
create_dir_if_not_exist "tests"
...
create_file_if_not_exist "AGENTS.md" "$agents_md"
...
create_file_if_not_exist "ARCHITECTURE.md" "$architecture_md"
...
create_file_if_not_exist ".claude/settings.json" "$settings_json"
...
create_file_if_not_exist "package.json" "$package_json"
...
create_file_if_not_exist ".claude/guides/pr-conventions.md" "$pr_conventions"
...
create_file_if_not_exist ".claude/guides/testing.md" "$testing_md"
...
create_file_if_not_exist "docs/design-docs/index.md" "$design_docs_index"
...
create_file_if_not_exist "docs/design-docs/core-beliefs.md" "$core_beliefs"
...
create_file_if_not_exist "docs/exec-plans/tech-debt-tracker.md" "$tech_debt_tracker"
...
create_file_if_not_exist "docs/DESIGN.md" "$design_md"
...
create_file_if_not_exist "docs/QUALITY_SCORE.md" "$quality_score_md"
...
create_file_if_not_exist "docs/RELIABILITY.md" "$reliability_md"
...
create_file_if_not_exist "docs/SECURITY.md" "$security_md"

# Create .gitkeep files for empty folders
gitkeep_content="# Keep directory in git"
create_file_if_not_exist "docs/exec-plans/active/.gitkeep" "$gitkeep_content"
create_file_if_not_exist "docs/exec-plans/completed/.gitkeep" "$gitkeep_content"
create_file_if_not_exist "docs/product-specs/.gitkeep" "$gitkeep_content"
create_file_if_not_exist "docs/references/.gitkeep" "$gitkeep_content"
create_file_if_not_exist "docs/generated/.gitkeep" "$gitkeep_content"
create_file_if_not_exist "tests/.gitkeep" "$gitkeep_content"

echo "=== Standardized Project Structure Setup Completed ==="
